...
from culture.controllers.ProduitController import modif_alerte_culture, modif_alerte_meteo_produit_page, new_produit, produit_list_page

urlpatterns = [
    path('parcelle_page/', parcelle_list_page, name='parcelle_page'),
    path('produit_page/', produit_list_page, name='produit_page'),
    path('new_parcelle/', new_parcelle, name='new_parcelle'),
    path('new_produit/', new_produit, name='new_produit'),
    path('modif_alerte_culture/', modif_alerte_culture, name='modif_alerte_culture'),
    ...
    path('modif_alerte_meteo_produit_page/<int:produit_id>/', modif_alerte_meteo_produit_page, name='modif_alerte_meteo_produit_page'),
]